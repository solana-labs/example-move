...
export async function createGenesis(
  ...
  const genesisAccount = await createAccount(connection, payerAccount, sizeOfGenesisAccount);
...
export async function pay(
  ...
  transaction.add({
    ...
    programId: MoveLoader.programId(),
    data: InstructionData.runPayFromSender(senderAccount.publicKey, payeeAccount.publicKey, amount),
  });
 ...
 */
export async function getLibraBalance(connection: Connection, publicKey: PublicKey): Promise<number> {
