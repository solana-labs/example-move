...
```sh
$ export RUST_LOG=solana_runtime::native_loader=warn,solana_runtime::bank=debug,solana_bpf_loader=debug,solana_rbpf=debug,solana_move_loader_program=debug
```
